    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p>We are problem solver and a creative thinker. Armed with a robust skill set, I specialize in crafting responsive and visually appealing websites that seamlessly blend form and function. Whether it's bringing a design to life with HTML, CSS, and JavaScript or architecting dynamic web applications on the server-side, I thrive on the challenges of the ever-evolving tech landscape..</p>
      ...
      <div class="row pt-5 mt-5 text-center">
        <div class="col-md-12">
          ...
          Copyright &copy; </script><script>document.write(new Date().getFullYear());</script> This JobBoard develop by <a href="https://www.instagram.com/_rocky_________/" target="_blank" >shubham and Ripal</a>
...
</html><?php /**PATH C:\Users\shubh\OneDrive\Desktop\OPH\resources\views////frontend/partials/footer.blade.php ENDPATH**/ ?>