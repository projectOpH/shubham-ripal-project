      ...
      <div class="site-navbar bg-light">
        <div class="py-1">
          <div class="row align-items-center">
            <div class="col-2">
              <h2 class="mb-0 site-logo"><a href="/">Opportunity<strong class="font-weight-bold">Hub</strong> </a></h2>
            </div>
            <div class="col-10">
              <nav class="site-navigation text-right" role="navigation">
                <div class="container pr-0">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li class="<?php echo e(request()->routeIs('employer.register') ? 'active' : ''); ?>"><a href="<?php echo e(route('employer.register')); ?>">For Employees</a></li>
                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php /**PATH C:\Users\shubh\OneDrive\Desktop\OPH\resources\views/frontend/partials/nav.blade.php ENDPATH**/ ?>